...
<head profile="<?php print $grddl_profile; ?>">
  <?php print $head; ?>
<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,800|Roboto:400,900' rel='stylesheet' type='text/css'>
  <title><?php print $head_title; ?></title>
  <?php print $styles; ?>
  <?php print $scripts; ?>
  <meta name="google-site-verification" content="Nr9lNLgcidLAlLfyAX8ULSg6LwO0_SEbRXkPrSD37LU" />
</head>
